...
export const api = {
  ...
  // ─── Status do Barbeiro ───────────────────────────────────────────
  updateBarberStatus: (status: BarberStatus) =>
    apiFetch<{ success: boolean; status: BarberStatus }>("/api/barbers/me/status", {
      method: "PATCH",
  ...
  // ─── Fila de Espera ───────────────────────────────────────────────
  addQueue: () =>
    apiFetch<{ success: boolean; queueCount: number }>("/api/barbers/me/queue/add", {
      method: "POST",
    }),

  removeQueue: () =>
    apiFetch<{ success: boolean; queueCount: number }>("/api/barbers/me/queue/remove", {
      method: "POST",
    }),
